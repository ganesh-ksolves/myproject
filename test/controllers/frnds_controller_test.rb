...
class FrndsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frnd" do
    assert_difference("Frnd.count") do
      post frnds_url, params: { frnd: { city: @frnd.city, email: @frnd.email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone_no: @frnd.phone_no } }
    end
  ...
  test "should update frnd" do
    patch frnd_url(@frnd), params: { frnd: { city: @frnd.city, email: @frnd.email, first_name: @frnd.first_name, last_name: @frnd.last_name, phone_no: @frnd.phone_no } }
